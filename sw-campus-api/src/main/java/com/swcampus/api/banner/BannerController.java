...
public class BannerController {
        ...
        public ResponseEntity<List<BannerResponse>> getActiveBanners() {
                List<BannerWithLectureDto> banners = bannerService.getActiveBannerWithLectureList();
        ...
        public ResponseEntity<List<BannerResponse>> getActiveBannersByType(
                ...
                List<BannerWithLectureDto> banners = bannerService.getActiveBannerWithLectureListByType(type);
                List<BannerResponse> response = banners.stream()
                                .map(BannerResponse::from)
                                .toList();
                return ResponseEntity.ok(response);
        ...
        public ResponseEntity<List<BannerResponse>> getBannersByLecture(
                ...
                List<BannerWithLectureDto> banners = bannerService.getBannerWithLectureListByLectureId(lectureId);
                List<BannerResponse> response = banners.stream()
                                .map(BannerResponse::from)
                                .toList();
                return ResponseEntity.ok(response);
