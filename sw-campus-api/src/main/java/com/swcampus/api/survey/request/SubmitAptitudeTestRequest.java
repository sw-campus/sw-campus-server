...
public class SubmitAptitudeTestRequest {
    ...
    @Schema(description = "Part 2 응답 (끈기/학습태도) - 값은 선택지 번호", example = "{\"q5\": 2, \"q6\": 1, \"q7\": 3, \"q8\": 2}")
    @NotNull(message = "Part 2 응답은 필수입니다")
    @Size(min = 1, message = "Part 2는 최소 1개 이상 응답해야 합니다")
    private Map<String, Integer> part2Answers;

    @Schema(description = "Part 3 응답 (직무 성향) - 값은 F/B/D", example = "{\"q9\": \"B\", \"q10\": \"B\", \"q11\": \"D\", \"q12\": \"B\", \"q13\": \"B\", \"q14\": \"B\", \"q15\": \"B\"}")
    @NotNull(message = "Part 3 응답은 필수입니다")
    @Size(min = 1, message = "Part 3은 최소 1개 이상 응답해야 합니다")
